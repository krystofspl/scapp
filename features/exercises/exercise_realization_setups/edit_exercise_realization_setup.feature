Feature: Edit existing exercise realization setup
  In order to manage exercise realizations
  As admin or coach
  I want to edit an exercise realization setup
  ...
  Scenario: As a coach who created the exercise realization, I want to edit a setup of an exercise set realization
    ...
    And I click "Edit" for exercise realization setup "setup2"
    And I fill in exercise realization setup fields
      | value | note       |
      | 5     | setup note |
    And I click "Save"
    Then I should see an exercise realization setup "setup2" with text "Value: 5.0 kg"